...
@Getter
@Entity
public class User  implements UserDetails{ // UserDetail을 상속받아 인증 객체 사용
  ...
  @Column(name = "password",nullable = false)
    ...
    @Override
    public String getUsername() {// 사용자의 id를 반환 (고유한값)
        return email;
    }
    ...
    @Override
    public boolean isCredentialsNonExpired() { //패스워드의 만료여부 확인
        return true;
    }
...
//UserDetails : 사용자의 인증 정보를 담아두는 인터페이스 이다. 객체를 통해 인증 정보를 가져오려면
// 필수 오버라이드된 매서드들이 필요하다.